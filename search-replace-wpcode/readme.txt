...
= 1.0.9 =
* New: Search terms and database table selections are now saved for quick reuse.
...
* Fix: We fixed some text-domains that were not correctly set for better translation support.
